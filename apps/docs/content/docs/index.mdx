...
**VernLLM** is a resilience layer for LLM applications. A lightweight wrapper that adds retries, timeouts, circuit breakers, caching, streaming, structured outputs, schema validation, usage tracking, and observability with sensible defaults and minimal dependencies.
