...
`unknown_tool` and `duplicate_tool_call_id` are deliberately non retryable. See [Tool Calling](/docs/core/tool-calling) for the canonical contract workflow and handling
