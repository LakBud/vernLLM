...
| Code                        | Error type       | Meaning                                                                                                                                                                                                                                                                                                                                                 |
| --------------------------- | ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `unsupported_capability`    | `invalid_params` | The caller asked for something this specific adapter, client, or model can't do: `stream: true` against a client with no streaming method, a model not covered by `toolUseSupportedModels`, `tools` combined with `jsonSchema` on a model not covered by `nativeStructuredOutputModels`, or `toolChoice: 'none'` against a provider with no equivalent. |
