...
`unknown_tool` and `duplicate_tool_call_id` are deliberately non retryable. See

<a href="/docs/core/tool-calling">Tool Calling</a> for the canonical contract workflow and handling
