...
<Cards>
  <Card title="Normalized Caching" href="/docs/guides/caching-methods/normalized">
    Match keys that differ only in outer whitespace, line endings, or Unicode form, using the
    built-in `NormalizedCacheAdapter`, no external dependencies or network calls.
  </Card>
...
- **Only formatting varies** (outer whitespace, line endings) between otherwise-identical prompts →
