...
Any violation throws `LLMError('validation')` before a request is sent. See{' '}

<a href="/docs/core/tool-calling">Tool Calling</a> for how this fits into a full request, execute,
continue loop.
